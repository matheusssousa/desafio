        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="search-form" action="{{ route('registros.update', $registro->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="nome" type="text"
                                        ...
                                        value="{{ old('nome', $registro->nome) }}" required autocomplete="nome" autofocus
                                        placeholder="Nome">
                                    @error('nome')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="cpf" type="text"
                                        ...
                                        value="{{ old('cpf', $registro->cpf) }}" required autocomplete="cpf"
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input id="idade" type="number"
                                        ...
                                        value="{{ old('idade', $registro->idade) }}" required autocomplete="idade" placeholder="Idade">
                                    @error('idade')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="sexo" id="sexo"
                                        ...
                                        <option value="Masculino" {{ old('sexo', $registro->sexo) == 'Masculino' ? 'selected' : '' }}>
                                            Masculino</option>
                                        <option value="Feminino" {{ old('sexo', $registro->sexo) == 'Feminino' ? 'selected' : '' }}>Feminino
                                        </option>
                                        <option value="Outro" {{ old('sexo', $registro->sexo) == 'Outro' ? 'selected' : '' }}>Outro
                                        </option>
                                    </select>
                                    @error('sexo')
                                        <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="cep" type="text"
                                        ...
                                        value="{{ old('cep', $registro->cep) }}" required autocomplete="cep" placeholder="99999-999">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="rua" type="text"
                                        ...
                                        value="{{ old('rua', $registro->rua) }}" required autocomplete="rua" placeholder="Rua">
                                    @error('rua')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="numero" type="text"
                                        ...
                                        value="{{ old('numero', $registro->numero) }}" required autocomplete="numero" placeholder="Número">
                                    @error('numero')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="bairro" type="text"
                                        ...
                                        value="{{ old('bairro', $registro->bairro) }}" required autocomplete="bairro" placeholder="Bairro">
                                    @error('bairro')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="cidade" type="text"
                                        ...
                                        value="{{ old('cidade', $registro->cidade) }}" required autocomplete="cidade" placeholder="Cidade">
                                    @error('cidade')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="estado" type="text"
                                        ...
                                        value="{{ old('estado', $registro->estado) }}" required autocomplete="estado" placeholder="Estado">
                                    @error('estado')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="ensino_medio" id="ensino_medio"
                                        ...
                                        <option value="1" {{ old('ensino_medio', $registro->ensino_medio) == '1' ? 'selected' : '' }}>Sim
                                        </option>
                                        <option value="0" {{ old('ensino_medio', $registro->ensino_medio) == '0' ? 'selected' : '' }}>Não
                                        </option>
                                    </select>
                                    @error('ensino_medio')
                                        <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="salario" type="number" step="0.01"
                                        ...
                                        value="{{ old('salario', $registro->salario) }}" required autocomplete="salario" placeholder="Salário">
                                    @error('salario')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
