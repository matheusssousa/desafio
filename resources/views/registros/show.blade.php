        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="search-form" action="{{ route('registros.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="cpf" type="text"
                                        ...
                                        value="{{ old('cpf') }}" required autocomplete="cpf" placeholder="999.999.999-99"
                                        disabled>
                                    @error('cpf')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="sexo" id="sexo"
                                        class="form-select @error('sexo') is-invalid @enderror" required disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="rua" type="text"
                                        ...
                                        value="{{ old('rua') }}" required autocomplete="rua" placeholder="Rua" disabled>
                                    @error('rua')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-4">
                                    <label for="ensino_medio"
                                        class="form-label">{{ __('Ensino médio completo?') }}</label>
                                    <select name="ensino_medio" id="ensino_medio"
                                        class="form-select @error('ensino_medio') is-invalid @enderror" required disabled>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="salario" type="number" step="0.01"
                                        ...
                                        value="{{ old('salario') }}" required autocomplete="salario"
                                        placeholder="Salário" disabled>
                                    @error('salario')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <a href="{{ route('registros.download', $registro->id) }}" class="btn btn-info">Download anexo</a>
